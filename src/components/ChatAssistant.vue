    ...
    <v-app>
        ...
        <v-layout>
            <v-app-bar style="background: linear-gradient(135deg, rgb(179, 208, 253) 0%, rgb(164, 202, 248) 100%);;"
                ...
                <v-app-bar-title
                    style="font-family: 'ZCOOL KuaiLe', sans-serif; font-size: 26px;">还没想好</v-app-bar-title>


                <v-btn style="font-weight: 1000;font-family: 'ZCOOL KuaiLe', sans-serif;" size="small"
                    @click="window.Android.redirect('https://www.ustb.edu.cn/')">
...
export default {
    ...
    data() {
        return {
            messages: [
                { sender: 'other', content: '请问今天能帮你做什么呢？😊' }
            ],
            newMessage: '',
            inputMode: 'voice',
            chartData: {
